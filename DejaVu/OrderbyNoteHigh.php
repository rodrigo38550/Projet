        ...
        <div class="slider">
          <div class="slider-page">
            <div class=show>
              ...
              $requete = "SELECT * FROM anime ORDER BY note DESC limit 0,24;"; ///Changer le noombres de tableau afficher ici
          ...
          <div class="slider-page">
            <div class=show>
              ...
              ///Gros bordel qui sert a afficher les anime présent dans la BDD avec vérification
              ///qui permet de ne pas afficher les valeurs NULL
              $requete = "SELECT * FROM anime ORDER BY note DESC, nom_en DESC LIMIT 24,24"; ///Changer  le nombre de tableau afficher ici
              $resultats = $bdd->prepare($requete);
              $resultats->execute();
          ...
          <div class="slider-page">
            <div class=show>
              ...
              ///Gros bordel qui sert a afficher les anime présent dans la BDD avec vérification
              ///qui permet de ne pas afficher les valeurs NULL
              $requete = "SELECT * FROM anime ORDER BY note DESC, nom_en DESC LIMIT 48,24"; ///Changer  le nombre de tableau afficher ici
              $resultats = $bdd->prepare($requete);
              $resultats->execute();
